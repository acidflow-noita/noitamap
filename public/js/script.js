    ...
    if (urlParams.has("map")) {
        ...
        switch (currentMapURL) {
            case "regular": {
                if (
                    !document
                        .getElementById("mapId0")
                        .classList.contains("active")
                ) {
                    document.getElementById("mapId0").classList.add("active");

                    document
                        .getElementById("mapId1")
                        .classList.remove("active");
                    document
                        .getElementById("mapId2")
                        .classList.remove("active");
                    document
                        .getElementById("mapId3")
                        .classList.remove("active");
                    document
                        .getElementById("mapId4")
                        .classList.remove("active");
                    document
                        .getElementById("mapId5")
                        .classList.remove("active");
                    document
                        .getElementById("mapId7")
                        .classList.remove("active");
                    document
                        .getElementById("mapId8")
                        .classList.remove("active");
                    document
                        .getElementById("mapId9")
                        .classList.remove("active");
                    document
                        .getElementById("mapId10")
                        .classList.remove("active");
