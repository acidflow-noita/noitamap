...
describe("POI sprite coverage", () => {
  ...
  const ITEM_POIS: Array<{ label: string; poi: any }> = [
    ...
    { label: "mimic", poi: { type: "item", item: "mimic" } },
    { label: "chest_leggy", poi: { type: "item", item: "chest_leggy" } },
    { label: "refresh_mimic", poi: { type: "item", item: "refresh_mimic" } },
    { label: "mimic_potion", poi: { type: "item", item: "mimic_potion" } },
