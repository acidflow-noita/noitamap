  ...
  () => {
    ...
    it("opens the TLDR and locked upsell without authentication", async () => {
      ...
      document.body.innerHTML =
        '<input id="seedReportToggleBtn" type="checkbox"><input id="drawToggleBtn" type="checkbox">';
      ...
      const hooks: any = {
        ...
        getAllDynamicPOIs: () => [
          { id: "chest-1", type: "chest", pw: 0, worldX: 0, worldY: 0 },
        ],
        getDynamicPOIs: () => [],
      ...
      expect(
        document.querySelector("#seed-report-sidebar.open"),
      ).not.toBeNull();
